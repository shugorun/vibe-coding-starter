...
会話内の新情報が増えてきたら、エージェントは作業を続ける前に docs 更新を提案する。

目安:

- アイデアの方向性が変わった
- 調査結果や外部情報が 3 件以上たまった
- ユーザが判断や好みを明示した
- 要件、画面、仕組み、技術方針のどれかが具体化した
- 後で見返す必要がある未確定事項が出た
- 20 分以上または大きな話題 1 つ分、記録していない

ユーザが「ここで記録」「いったん記録」「メモして」「ドキュメント更新して」と言った場合は、該当する docs に反映してから作業を続ける。
